...
const Beveromatic3dx3Lane = () => {
    ...
    const handleWhatsAppInquiry = (productName) => {
        const message = `Hi, I'm interested in the Beveromatic 3DX 3 Lane Vending Machine. Can you provide more information?`;
                        ...
                        <div className="md:w-1/2">
                            <div className="space-y-4">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-white/60">BV03DX</span>
                                </div>
                                <h1 className="text-4xl font-bold">Beveromatic 3DX 3 Lane Vending Machine</h1>
                                <p className="text-white/80 text-lg leading-relaxed">Beveromatic 3DX is designed for fast-paced environments that require quick service and high efficiency. With its triple dispensing system, this model is ideal for food courts, cafeterias, and large commercial setups.</p>
                                <button
                ...
                <div className="mb-16">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <div className="bg-white shadow-md hover:shadow-lg transition-shadow p-6 rounded-xl text-center">
                            ...
                            <span className="text-gray-700 font-medium">Malls</span>
                        </div>
                        <div className="bg-white shadow-md hover:shadow-lg transition-shadow p-6 rounded-xl text-center">
                            <Building2 className="text-[#3D1808] mx-auto mb-3" size={24} />
                        ...
                        <div className="bg-white shadow-md hover:shadow-lg transition-shadow p-6 rounded-xl text-center">
                            <Building2 className="text-[#3D1808] mx-auto mb-3" size={24} />
                            <span className="text-gray-700 font-medium">High-Demand Zones</span>
                        </div>
                        <div className="bg-white shadow-md hover:shadow-lg transition-shadow p-6 rounded-xl text-center">
                            <Building2 className="text-[#3D1808] mx-auto mb-3" size={24} />
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h3 className="font-semibold text-gray-900 mb-2">front_door_led</h3>
                                    <p className="text-gray-600">Front Door LED – Illuminating front door LED design</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h3 className="font-semibold text-gray-900 mb-2">three_simultaneous_dispensing</h3>
                                    <p className="text-gray-600">Three Simultaneous Dispensing Options – Reduces queues</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h3 className="font-semibold text-gray-900 mb-2">energy_efficient_system</h3>
                                    <p className="text-gray-600">Energy-Efficient System – Saves power while maintaining performance</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h3 className="font-semibold text-gray-900 mb-2">smart_control_panel</h3>
                                    <p className="text-gray-600">Smart Control Panel – Easy customization for beverage strength and quantity</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h3 className="font-semibold text-gray-900 mb-2">durable_hygienic_design</h3>
                                    <p className="text-gray-600">Durable & Hygienic Design – Ensures long-term use</p>
                                </div>
                            </div>
                        </div>
                    </div>
