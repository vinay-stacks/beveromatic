...
const Beveromatic4LaneVending = () => {
    ...
    const productUrl = ['/productImage/bv04dx-2.webp', '/productImage/bv04dx-3.webp', '/productImage/bv04dx-1.webp']
        ...
        <div className="min-h-screen">
            ...
            <div className="max-w-7xl mx-auto px-6 sm:px-6 lg:px-10 mt-24 md:mt-36">
                <div className='max-[769px]:mt-36'>
                    <img className="w-full h-full rounded-2xl" src={'/sliderImage/bv04dx-hero.webp'} alt="3DX 3Lan Hero" />
                </div>
            </div>
            {/* end of hero */}
                        ...
                        <div className="md:w-1/2">
                            <div className="space-y-4">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-dark">BV04DX</span>
                                </div>
                        ...
                        <table className="w-full">
                            <tbody>
                                <TableRow
                                    ...
                                    value={`320 mm x 580 mm x 600 mm`}
                                    highlight
                                />
                                <TableRow
                                    icon={Box}
                                    label="Packed Dimensions"
                                    value={`450 mm x 700 mm x 690 mm`}
                                />
                                <TableRow icon={Scale} label="Net Weight" value={'25 Kgs.'} highlight />
                                <TableRow icon={Scale} label="Gross Weight" value={'27 Kgs.'} />
                            </tbody>
                        </table>
                    </div>
                </div>
